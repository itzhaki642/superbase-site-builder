...
const industryClients = [
  ...
  { name: "טנא נוגה", mark: "טנא נוגה", meta: "מוצרי חלב" },
  ...
  { name: "משק צוריאל", mark: "משק צוריאל", meta: "מוצרי חלב" },
  { name: "וילי פוד", mark: "וילי פוד", meta: "תעשיית מזון" },
  { name: "טבע", mark: "טבע", meta: "פארמה" },
  { name: "אוסם", mark: "אוסם", meta: "מזון ומשקאות" },
];
