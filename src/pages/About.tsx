      ...
      <section className="border-b border-border bg-gradient-dark py-16 md:py-24">
        <div className="container">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-white/85">
            חברת נאור אדיר בע״מ הינה חברה מובילה בתחום הקירור התעשייתי בישראל. אנו מתמחים
            בייבוא, מכירה והתקנה של דלתות קירור איכותיות מהיצרנים המובילים בעולם, וכן במתן
            שירות תחזוקה ותיקונים לחדרי קירור עבור מגוון רחב של לקוחות תעשייתיים -
            ממפעלי מזון, רשתות שיווק, מחסנים לוגיסטיים ועד מוסדות בריאות ותעשייה כבדה.
          </p>
          <p className="mt-4 max-w-3xl text-lg leading-relaxed text-white/85">
            אנו מציעים פתרונות קירור מותאמים אישית לכל לקוח, תוך הקפדה על איכות בלתי מתפשרת,
            עמידה בלוחות זמנים ושירות אישי לאורך כל הדרך.
          </p>
        </div>
      </section>
